...
function initCalculadora() {
    class CalculadoraOrcamento {
        ...
        bindEvents() {
            ...
            // Lógica para os TÍTULOS DOS PASSOS
        ...
        // Os métodos de persistência comentados podem ficar aqui dentro, sem problemas.
    }
    
    // A instância da classe é chamada AQUI, dentro da função e depois da definição da classe.
...
// === SISTEMA DE ESTADOS VISUAIS DINÂMICOS ===
class DynamicStates {
    constructor() {
        this.init();
    }
    ...
    addHoverEffects() {
        // Efeito paralax sutil nos cards
    ...
    addActiveStates() {
        // Estados de clique mais expressivos
        document.querySelectorAll('.cta-button, .whatsapp-btn, .blog-filter-btn').forEach(button => {
